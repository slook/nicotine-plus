...
class Dialog:
    ...
    def __init__(self, parent=None, show_callback=None, close_callback=None, title="", modal=False, width=0, height=0):
    ...
    def present(self):
        ...
        if self.show_callback:
            self.show_callback(self.window.layout())
...
class MessageDialog(ttk.TTkMessageBox):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._default_focus_widget = None
        ...
        for button_response, button_label in buttons:
            ...
            if button_response == default_button:
                self._default_focus_widget = button
    ...
    def present(self):
        ...
        if self._default_focus_widget:
            self._default_focus_widget.setFocus()
