...
class UsersList(Tree):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(parent=parent, header=header, name=parent.name(), **kwargs)
        self.closed.connect(self.destroy)

        if parent.name() == "global_feed":
            return
    ...
    def destroy(self):
        ...
        self.itemActivated.disconnect(self.on_user_item_activated)
    ...
    def mouseEvent(self, evt):
        ...
        if evt.evt == ttk.TTkK.Press:
            ...
            if user_item is None:
                ...
                self.popup_menu = UserPopupMenu(self, user_item, closed_callback=self.on_popup_closed)
                self.popup_menu.setup(self.popup_menu)
