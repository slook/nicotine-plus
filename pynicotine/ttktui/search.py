...
class Searches(Pages):
    ...
    def __init__(self, screen, name="search"):
        ...
        self.room_search_combobox = ttk.TTkComboBox(parent=self.header_bar, editable=True,
                                                    insertPolicy=ttk.TTkK.NoInsert, visible=False, name="rooms")
        ...
        self.user_search_combobox = ttk.TTkComboBox(parent=self.header_bar, editable=True,
                                                    insertPolicy=ttk.TTkK.NoInsert, visible=False, name="user")
