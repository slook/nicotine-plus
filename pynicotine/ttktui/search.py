...
class Searches(Pages):
    ...
    def __init__(self, screen, name="search"):
        ...
        self.search_mode_combobox = ttk.TTkComboBox(parent=self.header, list=list(self.MODES.values()), index=0)
        ...
        self.room_search_combobox = ttk.TTkComboBox(parent=self.header, editable=True, insertPolicy=ttk.TTkK.NoInsert, visible=False)
        self.room_search_combobox.lineEdit()._hint = ttk.TTkString(_("Room…"))
        #self.room_search_combobox.setMinimumWidth(core.chatrooms.ROOM_NAME_MAX_LENGTH + 4)
        ...
        self.user_search_combobox = ttk.TTkComboBox(parent=self.header, editable=True, insertPolicy=ttk.TTkK.NoInsert, visible=False)
        self.user_search_combobox.lineEdit()._hint = ttk.TTkString(_("Username…"))
        #self.user_search_combobox.setMinimumWidth(core.users.USERNAME_MAX_LENGTH + 4)
        ...
        self.search_combobox = ttk.TTkComboBox(parent=self.header, editable=True, insertPolicy=ttk.TTkK.NoInsert)
        self.search_combobox.lineEdit()._hint = ttk.TTkString(_("Search term…"))
        self.search_combobox.setMinimumWidth(10)
