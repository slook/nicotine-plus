...
class Transfers(ttk.TTkContainer):
    ...
    def __init__(self, screen, name=None):
        ...
        self.placeholder = ttk.TTkLabel(parent=self._spacer, enabled=False, alignment=ttk.TTkK.CENTER_ALIGN)
    ...
    def activate_transfer(self, transfer):
        ...
        action = config.sections["transfers"][f"{self.name().rstrip('s')}_doubleclick"]
