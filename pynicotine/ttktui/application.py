...
class Application(TTk):
    ...
    def create_file_menu(self, header_menu, _position=None):
        ...
        self.file_menu._connect = self.file_menu.addMenu(_("_Connect").replace("_", "&"))
        self.file_menu._connect.menuButtonClicked.connect(self.on_connect)
        self.file_menu._disconnect = self.file_menu.addMenu(_("_Disconnect").replace("_", "&"))
        self.file_menu._disconnect.menuButtonClicked.connect(self.on_disconnect)
        self.file_menu._privileges = self.file_menu.addMenu(_("Soulseek _Privileges").replace("_", "&"))

        self._update_user_status()

        self.file_menu.addSpacer()
        self.file_menu.addMenu(_("_Preferences").replace("_", "&")).menuButtonClicked.connect(self.on_preferences)
        self.file_menu.addSpacer()
        self.file_menu._quit = self.file_menu.addMenu(_("_Quit").replace("_", "&"))
