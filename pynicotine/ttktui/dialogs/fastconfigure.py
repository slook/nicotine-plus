...
class FastConfigure(Dialog):
    ...
    def load(self, parent):
        ...
        self.texts = {
            ...
            "account_page": {
                ...
                self.invalid_username_text: _(
                    "Log in to an existing Soulseek account or create a new one. Usernames are case-sensitive and "
                    "unique."
                ),
    ...
    def on_edit_shared_folder(self):
        ...
        def response(dialog, _response_id, old_share_item):
            ...
            old_share_item.setSelected(False)  # FIXME unselected item still in selectedItems
            ...
            new_share_item.setSelected(True)
    ...
    def on_remove_shared_folder(self):
        ...
        for share_item in reversed(self.shares_list_view.selectedItems()):
            ...
            #share_item.setSelected(False)  ## FIXME item isSelected after removed
    ...
    def on_next(self):
        ...
        if self.finished or next_index >= len(self.pages):
            self.on_finished(account_required=self.invalid_password or config.need_config())
            return
