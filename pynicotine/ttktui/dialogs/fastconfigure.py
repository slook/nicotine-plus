...
class FastConfigure(Dialog):
    ...
    def create_share_page(self, parent):
        ...
        self.download_frame.layout().addWidget(ttk.TTkSpacer(maxWidth=8), 1, 4)
        ...
        self.open_download_folder_button = ttk.TTkButton(text="⌼", maxWidth=3)
        self.open_download_folder_button.setToolTip(_("Open in File Manager"))
        self.open_download_folder_button.setEnabled(not self.isolated_mode)
        self.open_download_folder_button.clicked.connect(self.on_open_download_folder)
        ...
        self.download_frame.layout().addWidget(self.open_download_folder_button, 1, 2)
        self.download_frame.layout().addWidget(self.default_download_folder_button, 1, 3)
        self.download_frame.layout().addWidget(self.download_info_bar, 2, 0, 1, 5)
    ...
    def on_open_download_folder(self):
        folder_path = self.download_folder_button.path()
