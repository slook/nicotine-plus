...
class UserBrowses(Pages):
    ...
    def __init__(self, screen, name="userbrowse"):
        ...
        self.userbrowse_combobox = ttk.TTkComboBox(editable=True, insertPolicy=ttk.TTkK.NoInsert)
        self.userbrowse_combobox.lineEdit()._hint = ttk.TTkString(_("Username…") + "NOT IMPLEMENTED")
    ...
    def create_header(self):
        ...
        self.header_bar.layout().addWidget(self.userbrowse_combobox)
